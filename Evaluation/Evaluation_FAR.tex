...
This equation was applied across all wavelengths and magnetic field strengths. The raw experimental data are recorded in Table~\ref{tab:rotation_angle} and Table~\ref{tab:contrast_data}. By converting the applied coil current to the effective length-averaged magnetic field $\bar{B}_{\mathrm{eff}}$ (using the calibration from Part 2), the rotation angles as a function of the magnetic field were obtained. Table~\ref{tab:max_theta_results} summarizes the maximum rotation angles $\theta_{\mathrm{max}}$ measured at the highest applied magnetic field for both materials and all four wavelengths.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c c c}
    \toprule
    \textbf{Material} & \textbf{Wavelength [nm]} & \textbf{$\bar{B}_{\mathrm{eff, \max}}$ [mT]} & \textbf{$\theta_{\mathrm{\max}}$ [$^\circ$]} \\
    \midrule
    \textbf{N-BK7}
    & 400 & $12.41 \pm 0.19$ & $0.781 \pm 0.003$ \\
    & 470 & $12.36 \pm 0.19$ & $0.628 \pm 0.002$ \\
    & 508 & $12.36 \pm 0.19$ & $0.485 \pm 0.002$ \\
    & 628 & $12.17 \pm 0.19$ & $0.349 \pm 0.001$ \\
    \midrule
    \textbf{SF10}
    & 400 & $12.36 \pm 0.19$ & $3.438 \pm 0.017$ \\
    & 470 & $12.38 \pm 0.19$ & $2.225 \pm 0.008$ \\
    & 508 & $12.35 \pm 0.19$ & $1.732 \pm 0.007$ \\
    & 628 & $12.38 \pm 0.19$ & $1.145 \pm 0.005$ \\
    \bottomrule
  \end{tabular}
  \caption{Maximum magnetic flux density $\bar{B}_{\mathrm{eff, \max}}$ and the resulting maximum rotation angle $\theta_{\mathrm{\max}}$ calculated for each wavelength and material combination.}\label{tab:max_theta_results}
\end{table}
