...
\subsubsection{Verification of Malus' Law (Without Glass)}
...
\begin{table}[h]
  ...
  \begin{tabular}{c c c}
    \hline
    {$\phi$ [$^\circ$]} & {$I_{\text{Glass}}$ [mV]} & {$I_{\text{No Glass}}$ [mV]} \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c c}
    \hline
    \textbf{Parameter} & \textbf{Air (No Glass)} & \textbf{Glass Sample} \\
    \hline
...
\end{equation}
This slope represents the conversion factor between the rotation angle $\theta$ (induced by the Faraday effect) and the measured change in intensity.

% --- Task 7: Optimization Check ---
...
\subsubsection{Modulation of the Magnetic Field}
