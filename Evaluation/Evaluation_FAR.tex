...
\subsection{Part 3:}
\subsubsection{Determination of Faraday Rotation Angles}

To calculate the Faraday rotation angle $\theta$ for each measurement, the ratio of the AC modulation signal $U_{SS}$ to the DC background signal $U_{DC}$ was utilized. The analyzer was set to the working point of $\phi = 45^\circ$ relative to the extinction position. At this angle, the transmitted intensity $I$ is approximately half the maximum intensity ($I \approx I_0/2$). Consequently, the full intensity can be expressed as $I_0 \approx 2 \cdot U_{DC}$.
...
\end{equation}
This equation was used to convert the recorded electrical signals into the physical rotation angle $\theta$ (in radians) for all wavelengths and magnetic field strengths.
