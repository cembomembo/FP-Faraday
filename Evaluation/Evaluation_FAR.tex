...
The results in Table~\ref{tab:verdet_and_mass} show a clear trend: the rotation angle increases significantly as the wavelength decreases (normal dispersion). Furthermore, the rotation in the lead-containing glass (SF10) is consistently larger than in the crown glass (N-BK7) by a factor of approximately 4 to 5, indicating a much higher Verdet constant for SF10.
