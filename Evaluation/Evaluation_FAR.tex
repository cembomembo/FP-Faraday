...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \bottomrule
  \end{tabular}
  \caption{Axial magnetic-flux density profile $B(z)$ measured at $I_{\mathrm{eff}}=1.0\,\mathrm{A}$.}\label{tab:Bz_profile_1A}
\end{table}

From the measured profile, the effective length-averaged magnetic field was calculated using the trapezoidal rule with $\Delta z=0.5\,\mathrm{cm}$ and $L=7.0\,\mathrm{cm}$. For the $N=15$ measurement points, the discrete approximation of the integral is:
\begin{equation}
...
In addition, the manual positioning of the probe marker introduces an uncertainty in the covered integration length $L$, which we estimate as $\sigma_L \approx 0.1\,\mathrm{cm}$. With $\bar B_{\mathrm{eff}}\propto 1/L$, the corresponding contribution is:
\begin{equation}
...
For the field-current calibration, the Hall probe was fixed at the solenoid center ($z=3.5\,\mathrm{cm}$), and the maximal magnetic flux was recorded as a function of effective coil current $I_{\mathrm{eff}}$. Then, the averaged magnetic flux density was calculated as $\bar B = 0.8B_{\max}$.
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|}
    ...
    \bottomrule
  \end{tabular}
  \caption{Measured $B_{\max}$ values at $z=3.5\,\mathrm{cm}$ as a function of $I_{\mathrm{eff}}$.}\label{tab:Bcenter_Ieff}
\end{table}

\vspace{1em}
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{../resources/plots/part1/B_z.png}
  \caption{Magnetic flux density $B$ measured along the coil symmetry axis at a fixed current $I_{\mathrm{eff}}=1.0$A.}\label{fig:B_z}
\end{figure}

A linear regression of the averaged magnetic flux data yields the calibration relation
\begin{equation}
  \boxed{\bar B(I_{\mathrm{eff}}) = (7.92 \pm 0.03)\,\frac{\mathrm{mT}}{\mathrm{A}}\,I_{\mathrm{eff}} - (0.49 \pm 0.03)\,\mathrm{mT}} \;,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{../resources/plots/part1/Bcenter_calibration_fit.png}
  \caption{Calibration curve of the averaged solenoid center field $\bar B$ as a function of effective coil current $I_{\mathrm{eff}}$, including a linear regression fit.}\label{fig:Bcenter_calibration_fit}
\end{figure}
