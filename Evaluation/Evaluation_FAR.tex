...
\begin{table}[h]
  ...
  \begin{tabular}{S[table-format=2.0] S[table-format=2.1]}
    ...
    \bottomrule
  \end{tabular}
  \caption{Measured modulation signal amplitudes $U_{SS}$ varying with analyzer angle $\phi$. The measurement uncertainty is estimated as $\pm 0.1$\,mV.}\label{tab:modulation_data}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c c c c c}
    \toprule
    \multirow{2}{*}{\textbf{Wavelength}} & \multirow{2}{*}{\textbf{$I_{\mathrm{eff}}$ (A)}} & \multicolumn{2}{c}{\textbf{N-BK7}} & \multicolumn{2}{c}{\textbf{SF10}} \\
    \cmidrule(lr){3-4} \cmidrule(lr){5-6}
    & & \textbf{$U_{\mathrm{DC}}$ (V)} & \textbf{$U_{\mathrm{SS}}$ (mV)} & \textbf{$U_{\mathrm{DC}}$ (V)} & \textbf{$U_{\mathrm{SS}}$ (mV)} \\
    \midrule
    \textbf{400 nm} & 0.405           & 2.94  & 42.0  & 2.05 & 127.0 \\
    & 0.800           & 2.95  & 82.4  & 2.05 & 248.0 \\
    & 1.201 / 1.202   & 2.96  & 125.0 & 2.05 & 372.0 \\
    & 1.607 / 1.601   & 2.97  & 162.0 & 2.05 & 492.0 \\
    \midrule
    \textbf{470 nm} & 0.406 / 0.401   & 2.75  & 31.0  & 2.64 & 104.0 \\
    & 0.803 / 0.801   & 2.76  & 61.0  & 2.64 & 207.0 \\
    & 1.202 / 1.204   & 2.76  & 92.4  & 2.64 & 307.0 \\
    & 1.601 / 1.603   & 2.76  & 121.0 & 2.64 & 410.0 \\
    \midrule
    \textbf{508 nm} & 0.401           & 0.797 & 6.64  & 2.54 & 78.0  \\
    & 0.804           & 0.797 & 7.9   & 2.53 & 155.0 \\
    & 1.204 / 1.203   & 0.795 & 9.5   & 2.54 & 232.0 \\
    & 1.601 / 1.600   & 0.798 & 27.0  & 2.53 & 306.0 \\
    \midrule
    \textbf{628 nm} & 0.402           & 2.58  & 17.0  & 2.59 & 51.6  \\
    & 0.802 / 0.800   & 2.58  & 29.3  & 2.59 & 101.0 \\
    & 1.202 / 1.205   & 2.58  & 46.8  & 2.59 & 152.0 \\
    & 1.576 / 1.604   & 2.57  & 62.6  & 2.54 & 203.0 \\
    \bottomrule
  \end{tabular}
  \caption{Experimental measurement data for the Faraday Effect. The coil current $I_{\mathrm{eff}}$ induces a magnetic field, while $U_{\mathrm{DC}}$ and $U_{\mathrm{SS}}$ represent the DC background intensity and the AC modulation signal, respectively.}\label{tab:rotation_angle}
\end{table}
...
\begin{table}[htbp]
  \centering
  \begin{tabular}{l c S[table-format=2.2] S[table-format=1.4]}
    \toprule
    \textbf{Material} & \textbf{Wavelength [nm]} & {$\bar{B}_{\mathrm{eff, max}}$ [mT]} & {$\theta_{\mathrm{max}}$ [$^\circ$]} \\
    \midrule
    \textbf{N-BK7} & 400 & 12.41 & 0.7813 \\
    & 470 & 12.36 & 0.6280 \\
    & 508 & 12.36 & 0.4846 \\
    & 628 & 12.17 & 0.3489 \\
    \midrule
    \textbf{SF10} & 400 & 12.36 & 3.4377 \\
    & 470 & 12.38 & 2.2246 \\
    & 508 & 12.35 & 1.7325 \\
    & 628 & 12.38 & 1.1448 \\
    \bottomrule
