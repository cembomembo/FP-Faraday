...
\paragraph{Results for BK7}
To analyze the BK7 glass, the refractive index data was extracted from the public database http://refractiveindex.info/. The analysis of the BK7 dispersion in the visible range yields a highly linear relationship, as shown in Figure~\ref{fig:nbk7_plots}. The results of the linear fit and the derived physical parameters are summarized in Table~\ref{tab:task1_results}.
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Dispersion analysis and linearization for BK7 glass with data from http://refractiveindex.info/. Only wavelenght wihtin the visible range were selected.}
...
\begin{equation}
  \frac{N_{\mathrm{dispersion}}}{N_{\mathrm{atoms}}} \approx 2.25
\end{equation}
...
It is interesting to see that at B = 0 tesla, the faraday rotation does not seem to be zero, as can be seen in fig. \ref{fig:angle_vs_B} and even better in fig. \ref{fig:angle_vs_B_zoomed}. There are two plausible reasons for this behavior, one could be that the zeropoint for the B field was shifted due to a misconfiguration. This is suggested by fig. \ref{fig:Bcenter_calibration_fit} and equation \ref{eq:Bcenter_calibration_fit}, where for no current the magnetic field is negative. That is likely due to a miscalibration of the teslameter. If this is taken into consideration, that can account towards a shift in the magnetic field strength seen in fig. \ref{fig:angle_vs_B} and \ref{fig:angle_vs_B_zoomed} of $0.49\cdot\sqrt{2} \pm 0.03 \cdot \sqrt{2} \approx 0.69 \pm 0.04 $.\\
...
The results demonstrate a clear wavelength dependence: the Verdet constant decreases strongly with increasing wavelength, which is characteristic of normal dispersion far from the material's resonance frequencies. Furthermore, the lead-containing SF10 glass exhibits a Verdet constant that is approximately three to four times larger than that of the N-BK7 crown glass across the entire measured spectrum, indicating a much stronger magneto-optical response.
