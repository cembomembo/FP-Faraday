...
The magnetic field is modulated by driving the solenoid with an alternating current at a frequency in the range
$40\,\mathrm{Hz} \le \Omega \le 90\,\mathrm{Hz}$.
...
With the analyzer adjusted to the working point, the analyzer angle $\varphi$ is varied and for each angle the peak-to-peak amplitude $I_{SS}$ is recorded on the oscilloscope.
...
\subsection{Task 1: Determination of the Effective Resonance Wavelength}
